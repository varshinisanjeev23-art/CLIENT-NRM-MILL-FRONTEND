                ...
                <div className="relative aspect-square overflow-hidden bg-[#fafafa]">
                  {p.imageUrl ? (
                    <Link to={`/products/p/${p._id}`}>
                      <img
                        src={`${import.meta.env.VITE_API_BASE_URL || 'http://localhost:5000'}${p.imageUrl}`}
                        alt={p.name}
            ...
            <div className="flex justify-center gap-3">
              {[
                ...
                <button 
                  ...
                  className={`w-12 h-12 rounded-full border-[1.5px] font-bold text-xs flex items-center justify-center transition-all ${
                    weight === opt.val 
